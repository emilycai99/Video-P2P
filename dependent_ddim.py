...
class DDIMScheduler_dependent(SchedulerMixin, ConfigMixin):
    """
    ...
    def step(
        ...
        if eta > 0:
            ...
            if variance_noise is None:
                if dependent_sampler is not None and dependent:
                    # print('Use our ar noise!')
                    variance_noise = dependent_sampler.sample(model_output)
                else:
                    if device.type == "mps":
    ...
    def add_noise(
        ...
        ### TODO: here the noise should come from unet
